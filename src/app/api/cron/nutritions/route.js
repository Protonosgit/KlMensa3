...
async function requestNutrition(rlist) {
  ...
  try {
    ...
    const parts =  [{text: `Analyze this food image and provide detailed nutritional information. Identify the main dish/meal name and break down all individual food items with their estimated portion sizes. Use knowledge of the image (if attached), title and additives: aID: 8f232110 ${rlist.text} Respond ONLY with valid structured JSON, no additional text or formatting and use units like kcal for calories, mg/g for (micro-)/nutrients and % for the health score (higher is better). If a meal could not be parsed respond with: {error: "three_word_reason"}. Example: {"aID": "00000000", "score": 100, "dishTitle": "meal title here","items": [{"name": "most relevant part","portion": "150g"},{"name": "another item","portion": "200g"},],"nutrition": {"calories": 0,"protein": 0,"carbohydrates": 0,"fat": 0,"fiber": 0, "sugar: 0},"micronutrients": {"vitamin_b12":0.0,"iron": 0.0,"sodium": 0.0,"calcium": 0.0}}`,}];
